...
struct
    ...
    val regList = 
        let fun addToList ((temp, assignedRegister), listSoFar) = listSoFar @ [assignedRegister]
        in foldl addToList [] (Frame.callersaves @ Frame.calleesaves @ Frame.argregs @ Frame.specialregs)
        end
